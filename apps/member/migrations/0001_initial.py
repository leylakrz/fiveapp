    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('register_time', models.DateTimeField(auto_now_add=True, verbose_name='date joined')),
                ('gender', models.CharField(blank=True, choices=[('F', 'Female'), ('M', 'Male')], max_length=1, null=True, verbose_name='Gender')),
                ('website', models.CharField(blank=True, max_length=50, null=True, verbose_name='Website Link')),
